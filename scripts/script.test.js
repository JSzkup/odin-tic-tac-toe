...
describe('Win Conditions', () => {
    ...
    test('should detect a winner in row 0', () => {
        gameBoard.placeToken(0, 0, 'X');
    ...
    test('should detect a winner in row 1', () => {
    ...
    test('should detect a winner in row 2', () => {
        gameBoard.placeToken(2, 0, 'X');
        gameBoard.placeToken(2, 1, 'X');
    ...
    test('should detect a winner in column 0', () => {
    ...
    test('should detect a winner in column 1', () => {
    ...
    test('should detect a winner in column 2', () => {
        gameBoard.placeToken(0, 2, 'O');
        gameBoard.placeToken(1, 2, 'O');
        gameBoard.placeToken(2, 2, 'O');
        const winner = gameLogic.checkWinner();
        console.log(`Column winner check: ${winner}`);
        expect(winner).toBe('O');
    });
